...
const S = {
  ...
  body: {
    padding:'16px',maxHeight:'340px',overflow:'auto',
  ...
  prompt: { color:'var(--text-muted)',marginRight:'8px',userSelect:'none' },
  banner: (status) => ({
    marginTop:'12px',padding:'10px 14px',
    borderLeft:`3px solid ${status==='running'?'var(--success)':'var(--danger)'}`,
  ...
  connecting: {
    ...
    fontSize:'11px',animation:'pulse 1.5s ease infinite',
  },
};
